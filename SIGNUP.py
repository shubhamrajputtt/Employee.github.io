...
c=con.cursor()
#c.execute("create table employeedata (Name text,userid text,password text,shift text,designation text,department text,salary int, increment int,dob string,adress text,mobile_no int,qualification string)")
con.commit()
...
l12=Label(obj,text="QUALIFICARION",fg='black',bg='white',font=("Times New Roman",14,'bold'))
l12.grid(row=15,column=0)
e12=Entry(obj,justify="left",bg="white",bd=5,insertwidth=5,textvariable=a12)
e12.grid(row=15,column=5)

b2=Button(obj,text="Employee details",fg="black",bg="white",command=prevPage,font=("Times New Roman",12,'bold'))
...
b2=Button(obj,text="sign up",fg="black",bg="white",command=insert,font=("Times New Roman",12,'bold'))
