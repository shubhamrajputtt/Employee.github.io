...
def insert():
    ...
    con=sqlite3.connect("employee_register.db")
    c=con.cursor()
    c.execute("INSERT INTO managerdata VALUES(?,?,?,?,?,?,?,?,?,?,?,?)",(Name,userid,password,shift,designation,department,salary,increment,birth_date,adress,mobile_no,qualification))
